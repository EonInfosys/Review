...
namespace EonInfosys\Review\Model\Data;
...
class Review extends AbstractSimpleObject implements ReviewInterface
{
     ...
     * @inheritdoc
     *
     * @return \EonInfosys\Review\Api\Data\RatingVoteInterface[]
     */
     ...
     * @inheritdoc
     *
     * @param \EonInfosys\Review\Api\Data\RatingVoteInterface[] $ratings
     *
     * @return Review|void
     */
